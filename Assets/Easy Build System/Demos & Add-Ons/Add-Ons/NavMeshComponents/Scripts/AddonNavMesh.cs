...
[Addon("NavMeshComponents Add-On", "Update the NavMeshSurface components to each action (placement, destruction, edition)." +
    " Very useful for allowing your agents avoid new pieces. You can find more information about this component in the documentation.", AddonTarget.BuildManager)]
